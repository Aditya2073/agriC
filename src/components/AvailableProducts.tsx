    ...
    <div className="space-y-6">
        ...
        {filteredProduces.map((produce) => (
          ...
          >
            <div className="p-6">
              ...
              <p className="mt-2 text-gray-600 text-sm">{produce.description}</p>
              <div className="mt-4">
              ...
              <button
                ...
                className={`mt-4 w-full px-4 py-2 rounded-lg font-medium transition-colors duration-200 ${
                  produce.quantity === 0
      ...
      {selectedProduce && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-[60]">
          <div className="bg-white rounded-xl p-6 max-w-md w-full relative z-[70]">
            <h3 className="text-xl font-semibold text-gray-900 mb-4">
              Purchase {selectedProduce.name}
            </h3>
